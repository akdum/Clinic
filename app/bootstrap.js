System.register(['angular2/platform/browser', './components/app.component', './services/assets.service', './services/contacts.service', './services/services.service', './services/special.offers.service', './services/news.service', './services/db.service', './services/utilities.service', './services/doctors.service', './services/about.service', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var browser_1, app_component_1, assets_service_1, contacts_service_1, services_service_1, special_offers_service_1, news_service_1, db_service_1, utilities_service_1, doctors_service_1, about_service_1, router_1;
    return {
        setters:[
        ...
        execute: function() {
            browser_1.bootstrap(app_component_1.AppComponent, [assets_service_1.AssetsService,
